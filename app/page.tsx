  ...
  useEffect(() => {
    const fetchPrices = async () => {
      try {
        ...
        setPrices(priceData)
        // Update market data based on prices
        setMarketData({
          volume: 2400000 + (priceData.BTC || 45000) * 0.1, // Mock volume
          users: 1234,
          positions: 89,
          leverage: 25,
        })
        ...
        setPrices({ BTC: 45000, ETH: 2800, STX: 2.5, SOL: 180 }) // Fallback
      } finally {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button onClick={() => router.push("/trade")} size="lg" className="bg-blue-600 hover:bg-blue-700">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card className="bg-gray-800 border-gray-700">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-white">${(marketData.volume / 1000000).toFixed(1)}M</div>
        ...
        <Card className="bg-gray-800 border-gray-700">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-white">{marketData.users.toLocaleString()}</div>
            <p className="text-xs text-muted-foreground">
        ...
        <Card className="bg-gray-800 border-gray-700">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-white">{marketData.positions}</div>
            <p className="text-xs text-muted-foreground">
              +12 from yesterday
            </p>
          </CardContent>
        ...
        <Card className="bg-gray-800 border-gray-700">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-white">{marketData.leverage}x</div>
            <p className="text-xs text-muted-foreground">
              +2.5x from last week
            </p>
          </CardContent>
        ...
        <Card className="bg-gray-800 border-gray-700">
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              {[
                { symbol: 'BTC', price: `$${prices.BTC?.toLocaleString() || '45,000'}`, change: '+5.2%', positive: true },
                { symbol: 'ETH', price: `$${prices.ETH?.toLocaleString() || '2,800'}`, change: '+3.1%', positive: true },
                { symbol: 'STX', price: `$${prices.STX?.toLocaleString() || '2.50'}`, change: '+16.0%', positive: true },
              ].map((item) => (
            ...
            <div>
              ...
              {[
                { symbol: 'SOL', price: `$${prices.SOL?.toLocaleString() || '180'}`, change: '-2.1%', positive: false },
      ...
      <Card className="bg-gray-800 border-gray-700">
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <Button variant="outline" onClick={() => router.push("/trade")} className="h-20 flex-col">
